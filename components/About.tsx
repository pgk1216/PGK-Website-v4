        ...
        id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
            <div className='w-[80%] m-auto md:grid grid-cols-3 gap-8 lg:max-w-[1240px]'>
                <div className='col-span-2'>
                    ...
                    <p className='py-2'>I am <span className='text-teal-700'>Philip Kim</span>, a Bachelor&apos;s degree graduate from University of Michigan - Ann Arbor. I recently worked at Alarm.com as a Software Engineer specializing in Android development under the emPower Connected Car team. I am currently open to work!</p>
