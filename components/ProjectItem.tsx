...
const ProjectItem = ({title, backgroundImage, tech, projectUrl}: {title: string, backgroundImage: StaticImageData, tech: string, projectUrl: string}) => {
    return (
        <div className='relative flex items-center justify-center shadow-xl shadow-gray-400 rounded-xl group hover:bg-teal-600'>
            <Image className='rounded-xl group-hover:opacity-10' src={backgroundImage} alt='/' width={300} height={300} /> 
