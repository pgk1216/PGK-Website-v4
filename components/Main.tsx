                ...
                <div>
                    ...
                    className='flex items-center justify-between text-[#ecf0f3] max-w-[330px] m-auto py-4'>
                        <a href='Philip_Kim_Resume.pdf' target='_blank'>
                            <p className='rounded-full text-[#ecf0f3] bg-teal-700 shadow-lg shadow-gray-400 py-4 px-6 cursor-pointer mx-auto hover:scale-105 ease-in duration-300'>View My Resume</p>
                        </a>
                        <a href='https://www.linkedin.com/in/philip-kim-ab367b178/' target='_blank'>
